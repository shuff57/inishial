...
**Pleasant Valley High School, Math Department, 2026-2027**

| Instructor | Steven Huff |
| :---- | :---- |
| **Email** | shuff@chicousd.org |
| **Courses and Time** | Introduction to Statistics, Periods 3, 4, 7 |
...
This course is offered for dual enrollment credit through Butte College as STAT C1000, Introduction to Statistics (4 units), formerly MATH 18\.
...
| **Hours** | 68 contact hours / 136 out-of-class hours / 204 total hours |
| **Term** | 2026-2027 |
...
1. Evaluate ethical issues in statistical practice.

2. Identify appropriate statistical techniques and use technology-based statistical analysis to describe, interpret, and communicate results.

3. Demonstrate an understanding of, and ability to use, basic ideas of statistical processes, including hypothesis tests and confidence interval estimation.

4. Describe and apply probability concepts and distributions.

5. Identify appropriate graphs and summary statistics for variables and relationships between them and correctly interpret information from graphs and summary statistics.

6. Assess how data were collected and recognize how data collection affects what conclusions can be drawn from the data.

---

## Course Content

These are the required topics for STAT C1000, totaling 68 lecture hours. We will move through them in roughly this order. Specific due dates live in MyOpenMath.
...
* [Introduction to Statistics](https://oerbookshelf.app/introduction-to-stats/) on bookSHelf. This is the course book, used for all readings, lessons, and practice. It is free and no account is required. Every section can be downloaded as an offline PDF or HTML.

* [rāSHio](%20https://rashio.app/%20) is the online statistics calculator for this course.

* Notebook or binder with both lined and graph paper
...
There is no textbook to purchase for this course. All readings and practice come from bookSHelf, and all graded work is in MyOpenMath.

* bookSHelf: [https://oerbookshelf.app/introduction-to-stats/](https://oerbookshelf.app/introduction-to-stats/) (open the link, no sign-in)

* MyOpenMath: [https://www.myopenmath.com/](https://www.myopenmath.com/)

* rāSHio: [https://rashio.app/](https://rashio.app/) 
...
Off campus, it is your responsibility to find or provide internet access. Assignments are completed and submitted in MyOpenMath, which is a web-based system. It has no offline mode, and answers cannot be submitted without a connection. If you know you will be offline, download your assignment as a PDF first and work the questions on paper, then enter your answers in MyOpenMath once you regain access.

Course materials are a different matter. Readings, lessons, and practice problems are in bookSHelf, which is fully offline compatible. It is your responsibility to click the offline section PDF or HTML and download it to your device so that you can review it at a later time. The calculator we use in this course is also offline accessible. If you know your internet access will be limited, download what you need in advance.

Limited or unavailable internet access at home is not considered an excuse for late or missed work.

---

## Course Usage of Aeries and MyOpenMath
...
All coursework for this class runs through MyOpenMath. MyOpenMath holds your student’s most current grade, even when I have not yet finished entering everything into Aeries. Parents/Guardians are encouraged to check MyOpenMath for missing, late, or otherwise open assignments. It is the fastest and most accurate picture of where your student stands. I’ll do my best to keep Aeries updated as quickly as possible.
...
| Daily classwork and homework | scored immediately in MyOpenMath |
...
* Attend class regularly. Each new lesson or unit in statistics is built upon what has come before. Therefore, it is required that students attend and participate starting on the first day of class. Continual participation and completion of assignments is necessary for success.
...
* Keep track of your own grade. Check MyOpenMath regularly for anything missing, late, or still open. No one is going to chase you down about it.

### As a Dual Enrollment Student

You are a Butte College student, not just a high school student in a math class. That comes with obligations that are yours alone:
...
* Expect real work outside of class. This is a 4-unit college course running on a high school bell schedule, and the time you spend on it outside of class is part of the course, not extra.
...
Excessive absenteeism is defined as not participating in the course for one week or more. Participation in the course involves completing course activities. Simply logging in to MyOpenMath does not count as participation.
...
* Reading assignments. Sections of *Introduction to Stats* on bookSHelf, read before or alongside the matching lesson.

* Practice problems. Problem sets in MyOpenMath tied to each section.

* Writing assignments. Explaining your reasoning in words, not just producing a number: describing how a standard deviation is found, or writing a sentence interpreting what a probability you just calculated actually means in context.

* Out-of-class assignments. Work that has to happen away from the classroom, including going out and collecting your own data for the Statistics Lab or for a question we are going to take up in class.

* Group work. Group tests at the end of each unit and a team Statistics Lab.

**Daily Classwork/Homework:** Classwork will be assigned in MyOpenMath by section and will be due the next time class meets after the conclusion of the prior section (usually daily assignments).
...
Reading, writing, and out-of-class assignments all count within Daily Classwork/Homework.

**Group Assessment:** At the end of every unit there will be a Group Test.

You will also complete a Statistics Lab. This is done over the course of a few days, working with an assigned team, to demonstrate your understanding of statistical concepts.

**Practice Test:** Before each Individual Test you are assigned a Practice Test. It is not an exam, it is a homework assignment and a readiness check, it counts in the Daily Homework/Classwork category, and you may redo it as many times as you want. It is the clearest signal you will get of whether you are ready for the Individual Test, so use it that way. If you cannot do the Practice Test without help, you are not ready.

**Individual Assessment:** At the end of each unit, after the Group Test and the Practice Test, students will take an Individual Test.

There are no retakes or corrections on Group Tests or Individual Tests.

**Methods of Evaluation:** The Butte College course outline of record for STAT C1000 states that methods of evaluation “could include but are not limited to quizzes, exams, laboratory work, field journals, projects, research demonstrations, etc.” and that “methods of evaluation are at the discretion of local faculty.” The assessment structure in this course, meaning daily classwork, practice tests, group tests, the Statistics Lab, and individual tests, is set under that authority, as is the no-retake, no-correction policy above.
...
* Late passes apply to daily classwork and homework only. They cannot be used on group tests or individual tests.
...
**No retakes.** There are no retakes and no corrections on Group Tests or Individual Tests. Late passes do not apply to them, and an excused absence does not create a second attempt. It only gives you time to take the assessment you missed.

The Practice Test is the exception. It is a homework assignment and a readiness check, graded in the Daily Homework/Classwork category, and you may redo it as many times as you want.
...
Practice Tests are graded in Daily Homework/Classwork. The Statistics Lab is graded in Group Assessments alongside the Group Tests.
...
Your percentage in MyOpenMath produces two grades, reported to two places:
...
**Finish an assignment more than twenty-four hours before it is due and you automatically earn a 2% bump on that assignment.** No request is needed. MyOpenMath applies it based on when you complete the assignment.

The assignment has to be genuinely finished, not merely started, at least twenty-four hours before the due date. Starting early and submitting at the deadline does not earn the bump. The bump applies to daily classwork and homework; there is no extra credit on Group Tests, Individual Tests, or the Statistics Lab, and no other extra credit is offered.

---

## Course Schedule

The calendar below lists every assignment for both semesters, with the class-meeting date for each of the two rotations. Dates are approximate and may shift as we go. Where a date here and a due date in MyOpenMath disagree, the MyOpenMath date governs.

### Semester 1 - Chapters 1-5

_18 teaching weeks, 83 school days, 37 assignments._

| # | Ch | Assignment | Odd-day class | Even-day class |
|---:|---:|---|---|---|
| 1 |  | Orientation and Syllabus | Wk 1 · Fri Aug 14 | Wk 2 · Mon Aug 17 |
| 2 | 1 | 1.1 Definitions of Statistics, Probability, and Key Terms | Wk 2 · Tue Aug 18 | Wk 2 · Wed Aug 19 |
| 3 | 1 | 1.2 Data, Sampling, and Variation in Data and Sampling | Wk 2 · Thu Aug 20 | Wk 2 · Fri Aug 21 |
| 4 | 1 | 1.3 Frequency, Frequency Tables, and Levels of Measurement | Wk 3 · Mon Aug 24 | Wk 3 · Tue Aug 25 |
| 5 | 1 | 1.4 Experimental Design and Ethics | Wk 3 · Wed Aug 26 | Wk 3 · Thu Aug 27 |
| 6 | 1 | 1.5 Lab: Data Collection Experiment · _Chapter 1 Practice Test assigned (homework)_ | Wk 3 · Fri Aug 28 | Wk 4 · Mon Aug 31 |
| 7 | 1 | **Chapter 1 Group Test** | Wk 4 · Tue Sep 01 | Wk 4 · Wed Sep 02 |
| 8 | 1 | **Chapter 1 Individual Test · _Chapter 1 Practice Test due_** | Wk 4 · Thu Sep 03 | Wk 4 · Fri Sep 04 |
| | | _Labor Day - no school_ | Wk 5 · Mon Sep 07 | Wk 5 · Mon Sep 07 |
| 9 | 2 | 2.1 Stem-and-Leaf Graphs, Line Graphs, and Bar Graphs | Wk 5 · Tue Sep 08 | Wk 5 · Wed Sep 09 |
| 10 | 2 | 2.2 Histograms, Frequency Polygons, and Time Series Graphs | Wk 5 · Thu Sep 10 | Wk 5 · Fri Sep 11 |
| 11 | 2 | 2.3 Measures of the Location of the Data + 2.4 Box Plots | Wk 6 · Mon Sep 14 | Wk 6 · Tue Sep 15 |
| 12 | 2 | 2.5 Measures of the Center + 2.6 Skewness and the Mean, Median, Mode | Wk 6 · Wed Sep 16 | Wk 6 · Thu Sep 17 |
| 13 | 2 | 2.7 Measures of the Spread of the Data | Wk 6 · Fri Sep 18 | Wk 7 · Mon Sep 21 |
| 14 | 2 | 2.8 Lab: Descriptive Statistics · _Chapter 2 Practice Test assigned (homework)_ | Wk 7 · Tue Sep 22 | Wk 7 · Wed Sep 23 |
| 15 | 2 | **Chapter 2 Group Test** | Wk 7 · Thu Sep 24 | Wk 7 · Fri Sep 25 |
| 16 | 2 | **Chapter 2 Individual Test · _Chapter 2 Practice Test due_** | Wk 8 · Mon Sep 28 | Wk 8 · Tue Sep 29 |
| 17 | 3 | 3.1 Terminology | Wk 8 · Wed Sep 30 | Wk 8 · Thu Oct 01 |
| 18 | 3 | 3.2 Independent and Mutually Exclusive Events | Wk 8 · Fri Oct 02 | Wk 9 · Mon Oct 05 |
| 19 | 3 | 3.3 Two Basic Rules of Probability | Wk 9 · Tue Oct 06 | Wk 9 · Wed Oct 07 |
| 20 | 3 | 3.4 Contingency Tables | Wk 9 · Thu Oct 08 | Wk 9 · Fri Oct 09 |
| 21 | 3 | 3.5 Tree and Venn Diagrams | Wk 10 · Mon Oct 12 | Wk 10 · Tue Oct 13 |
| 22 | 3 | 3.6 Lab: Probability Topics · _Chapter 3 Practice Test assigned (homework)_ | Wk 10 · Wed Oct 14 | Wk 10 · Thu Oct 15 |
| 23 | 3 | **Chapter 3 Group Test** | Wk 10 · Fri Oct 16 | Wk 11 · Mon Oct 19 |
| 24 | 3 | **Chapter 3 Individual Test · _Chapter 3 Practice Test due_** | Wk 11 · Tue Oct 20 | Wk 11 · Wed Oct 21 |
| 25 | 4 | 4.1 Probability Distribution Function (PDF) for a Discrete Random Variable | Wk 11 · Thu Oct 22 | Wk 11 · Fri Oct 23 |
| 26 | 4 | 4.2 Mean or Expected Value and Standard Deviation | Wk 12 · Mon Oct 26 | Wk 12 · Tue Oct 27 |
| 27 | 4 | 4.3 Binomial Distribution | Wk 12 · Wed Oct 28 | Wk 12 · Thu Oct 29 |
| 28 | 4 | 4.4 Lab: Discrete Distribution (Playing Card Experiment) | Wk 12 · Fri Oct 30 | Wk 13 · Mon Nov 02 |
| 29 | 4 | 4.5 Continuous Probability Functions | Wk 13 · Tue Nov 03 | Wk 13 · Wed Nov 04 |
| 30 | 4 | 4.6 Lab: Continuous Distribution · _Random Variables Practice Test assigned (homework)_ | Wk 13 · Thu Nov 05 | Wk 13 · Fri Nov 06 |
| 31 | 4 | **Random Variables Group Test** | Wk 14 · Mon Nov 09 | Wk 14 · Tue Nov 10 |
| | | _Veterans Day - no school_ | Wk 14 · Wed Nov 11 | Wk 14 · Wed Nov 11 |
| 32 | 4 | **Random Variables Individual Test · _Random Variables Practice Test due_** | Wk 14 · Thu Nov 12 | Wk 14 · Fri Nov 13 |
| 33 | 5 | 5.1 The Standard Normal Distribution | Wk 15 · Mon Nov 16 | Wk 15 · Tue Nov 17 |
| 34 | 5 | 5.2 Using the Normal Distribution | Wk 15 · Wed Nov 18 | Wk 15 · Thu Nov 19 |
| | | _Thanksgiving Recess - no school_ | Mon Nov 23 - Fri Nov 27 | Mon Nov 23 - Fri Nov 27 |
| 35 | 5 | 5.3 Lab: Normal Distribution (Lap Times) · _Chapter 5 Practice Test assigned (homework)_ | Wk 15 · Fri Nov 20 | Wk 16 · Mon Nov 30 |
| 36 | 5 | **Chapter 5 Group Test** | Wk 16 · Tue Dec 01 | Wk 16 · Wed Dec 02 |
| 37 | 5 | **Chapter 5 Individual Test · _Chapter 5 Practice Test due_** | Wk 16 · Thu Dec 03 | Wk 16 · Fri Dec 04 |
|  |  | _(open - buffer)_ | Wk 17 · Mon Dec 07 |  |
|  |  | _Full Review 1 of 2_ | Wk 17 · Wed Dec 09 | Wk 17 · Tue Dec 08 |
|  |  | _Full Review 2 of 2_ | Wk 17 · Fri Dec 11 | Wk 17 · Thu Dec 10 |
|  |  | _Semester Final_ | Wk 18 · Tue Dec 15 | Wk 18 · Mon Dec 14 |
|  |  | _Semester Final (cont.)_ | Wk 18 · Thu Dec 17 | Wk 18 · Wed Dec 16 |
| | | _Secondary Pupil Free Day - no school_ | Wk 18 · Fri Dec 18 | Wk 18 · Fri Dec 18 |

### Semester 2 - Chapters 6-12

_21 teaching weeks, 97 school days, 43 assignments._

| # | Ch | Assignment | Odd-day class | Even-day class |
|---:|---:|---|---|---|
| | | _Winter Recess - no school_ | Mon Dec 21 - Fri Jan 01 | Mon Dec 21 - Fri Jan 01 |
| 1 | 6 | 6.1 The Central Limit Theorem for Sample Means (Averages) | Wk 1 · Tue Jan 05 | Wk 1 · Mon Jan 04 |
| 2 | 6 | 6.2 The Central Limit Theorem for Sums | Wk 1 · Thu Jan 07 | Wk 1 · Wed Jan 06 |
| 3 | 6 | 6.3 Using the Central Limit Theorem | Wk 2 · Mon Jan 11 | Wk 1 · Fri Jan 08 |
| 4 | 6 | 6.4 Lab: Central Limit Theorem (Pocket Change) · _Chapter 6 Practice Test assigned (homework)_ | Wk 2 · Wed Jan 13 | Wk 2 · Tue Jan 12 |
| 5 | 6 | **Chapter 6 Group Test** | Wk 2 · Fri Jan 15 | Wk 2 · Thu Jan 14 |
| | | _Martin Luther King, Jr. Day - no school_ | Wk 3 · Mon Jan 18 | Wk 3 · Mon Jan 18 |
| 6 | 6 | **Chapter 6 Individual Test · _Chapter 6 Practice Test due_** | Wk 3 · Wed Jan 20 | Wk 3 · Tue Jan 19 |
| 7 | 7 | 7.1 A Single Population Mean Using the Normal Distribution | Wk 3 · Fri Jan 22 | Wk 3 · Thu Jan 21 |
| 8 | 7 | 7.2 A Single Population Mean Using the Student t-Distribution | Wk 4 · Tue Jan 26 | Wk 4 · Mon Jan 25 |
| 9 | 7 | 7.3 A Population Proportion | Wk 4 · Thu Jan 28 | Wk 4 · Wed Jan 27 |
| 10 | 7 | 7.4 Lab: Confidence Interval (Home Costs) · _Chapter 7 Practice Test assigned (homework)_ | Wk 5 · Mon Feb 01 | Wk 4 · Fri Jan 29 |
| 11 | 7 | **Chapter 7 Group Test** | Wk 5 · Wed Feb 03 | Wk 5 · Tue Feb 02 |
| 12 | 7 | **Chapter 7 Individual Test · _Chapter 7 Practice Test due_** | Wk 5 · Fri Feb 05 | Wk 5 · Thu Feb 04 |
| 13 | 8 | 8.1 Null and Alternative Hypotheses | Wk 6 · Tue Feb 09 | Wk 6 · Mon Feb 08 |
| 14 | 8 | 8.2 Outcomes and the Type I and Type II Errors | Wk 6 · Thu Feb 11 | Wk 6 · Wed Feb 10 |
| | | _Lincoln's Birthday - no school_ | Wk 6 · Fri Feb 12 | Wk 6 · Fri Feb 12 |
| | | _Presidents' Day - no school_ | Wk 7 · Mon Feb 15 | Wk 7 · Mon Feb 15 |
| 15 | 8 | 8.3 Probability Distribution Needed for Hypothesis Testing | Wk 7 · Wed Feb 17 | Wk 7 · Tue Feb 16 |
| 16 | 8 | 8.4 Rare Events, the Sample, Decision and Conclusion + 8.5 Additional Information and Full Hypothesis Test Examples | Wk 7 · Fri Feb 19 | Wk 7 · Thu Feb 18 |
| 17 | 8 | 8.6 Lab: Hypothesis Testing of a Single Mean and Single Proportion · _Chapter 8 Practice Test assigned (homework)_ | Wk 8 · Tue Feb 23 | Wk 8 · Mon Feb 22 |
| 18 | 8 | **Chapter 8 Group Test** | Wk 8 · Thu Feb 25 | Wk 8 · Wed Feb 24 |
| 19 | 8 | **Chapter 8 Individual Test · _Chapter 8 Practice Test due_** | Wk 9 · Mon Mar 01 | Wk 8 · Fri Feb 26 |
| 20 | 9 | 9.1 Two Population Means, Unknown SD + 9.2 Two Population Means, Known SD | Wk 9 · Wed Mar 03 | Wk 9 · Tue Mar 02 |
| 21 | 9 | 9.3 Comparing Two Independent Population Proportions | Wk 9 · Fri Mar 05 | Wk 9 · Thu Mar 04 |
| 22 | 9 | 9.4 Matched or Paired Samples | Wk 10 · Tue Mar 09 | Wk 10 · Mon Mar 08 |
| 23 | 9 | 9.5 Lab: Hypothesis Testing for Two Means and Two Proportions · _Chapter 9 Practice Test assigned (homework)_ | Wk 10 · Thu Mar 11 | Wk 10 · Wed Mar 10 |
| | | _Spring Recess - no school_ | Mon Mar 15 - Fri Mar 19 | Mon Mar 15 - Fri Mar 19 |
| 24 | 9 | **Chapter 9 Group Test** | Wk 11 · Mon Mar 22 | Wk 10 · Fri Mar 12 |
| 25 | 9 | **Chapter 9 Individual Test · _Chapter 9 Practice Test due_** | Wk 11 · Wed Mar 24 | Wk 11 · Tue Mar 23 |
| | | _Spring Travel Day - no school_ | Wk 11 · Fri Mar 26 | Wk 11 · Fri Mar 26 |
| | | _In Lieu Admission Day - no school_ | Wk 12 · Mon Mar 29 | Wk 12 · Mon Mar 29 |
| 26 | 10 | 10.1 Facts About the Chi-Square Distribution + 10.2 Goodness-of-Fit Test | Wk 12 · Tue Mar 30 | Wk 11 · Thu Mar 25 |
| 27 | 10 | 10.3 Test of Independence | Wk 12 · Thu Apr 01 | Wk 12 · Wed Mar 31 |
| 28 | 10 | 10.4 Test for Homogeneity + 10.5 Comparison of the Chi-Square Tests | Wk 13 · Mon Apr 05 | Wk 12 · Fri Apr 02 |
| 29 | 10 | 10.7 Lab: Chi-Square Goodness-of-Fit · _Chapter 10 Practice Test assigned (homework)_ | Wk 13 · Wed Apr 07 | Wk 13 · Tue Apr 06 |
| 30 | 10 | **Chapter 10 Group Test** | Wk 13 · Fri Apr 09 | Wk 13 · Thu Apr 08 |
| 31 | 10 | **Chapter 10 Individual Test · _Chapter 10 Practice Test due_** | Wk 14 · Tue Apr 13 | Wk 14 · Mon Apr 12 |
| 32 | 11 | 11.1 Linear Equations + 11.2 Scatter Plots | Wk 14 · Thu Apr 15 | Wk 14 · Wed Apr 14 |
| 33 | 11 | 11.3 The Regression Equation | Wk 15 · Mon Apr 19 | Wk 14 · Fri Apr 16 |
| 34 | 11 | 11.4 Testing the Significance of the Correlation Coefficient | Wk 15 · Wed Apr 21 | Wk 15 · Tue Apr 20 |
| 35 | 11 | 11.5 Prediction + 11.6 Outliers | Wk 15 · Fri Apr 23 | Wk 15 · Thu Apr 22 |
| | | _Nonwork day for employees under 12 months - no school_ | Wk 16 · Mon Apr 26 | Wk 16 · Mon Apr 26 |
| 36 | 11 | 11.7 Lab: Regression (Distance from School) · _Chapter 11 Practice Test assigned (homework)_ | Wk 16 · Wed Apr 28 | Wk 16 · Tue Apr 27 |
| 37 | 11 | **Chapter 11 Group Test** | Wk 16 · Fri Apr 30 | Wk 16 · Thu Apr 29 |
| 38 | 11 | **Chapter 11 Individual Test · _Chapter 11 Practice Test due_** | Wk 17 · Tue May 04 | Wk 17 · Mon May 03 |
| 39 | 12 | 12.1 One-Way ANOVA | Wk 17 · Thu May 06 | Wk 17 · Wed May 05 |
| 40 | 12 | 12.2 The F Distribution and the F Ratio + 12.3 Facts About the F Distribution | Wk 18 · Mon May 10 | Wk 17 · Fri May 07 |
| 41 | 12 | 12.5 Lab: One-Way ANOVA · _Chapter 12 Practice Test assigned (homework)_ | Wk 18 · Wed May 12 | Wk 18 · Tue May 11 |
| 42 | 12 | **Chapter 12 Group Test** | Wk 18 · Fri May 14 | Wk 18 · Thu May 13 |
| 43 | 12 | **Chapter 12 Individual Test · _Chapter 12 Practice Test due_** | Wk 19 · Tue May 18 | Wk 19 · Mon May 17 |
|  |  | _Full Review 1 of 3_ | Wk 19 · Thu May 20 | Wk 19 · Wed May 19 |
|  |  | _Full Review 2 of 3_ | Wk 20 · Mon May 24 | Wk 19 · Fri May 21 |
|  |  | _Full Review 3 of 3_ | Wk 20 · Wed May 26 | Wk 20 · Tue May 25 |
|  |  | _Semester Final_ | Wk 20 · Fri May 28 | Wk 20 · Thu May 27 |
| | | _Memorial Day - no school_ | Wk 21 · Mon May 31 | Wk 21 · Mon May 31 |
|  |  | _Semester Final (cont.)_ | Wk 21 · Wed Jun 02 | Wk 21 · Tue Jun 01 |
|  |  | _Make-up / course close-out_ |  | Wk 21 · Thu Jun 03 |

### Non-school days

30 weekdays lost inside the school year. A closure does **not** advance
the odd/even counter - it pushes the rotation, so the parity resumes where it left off.

| Date | Weekday | Reason | Part of |
|---|---|---|---|
| Sep 07, 2026 | Monday | Labor Day | - |
| Nov 11, 2026 | Wednesday | Veterans Day | - |
| Nov 23, 2026 | Monday | Thanksgiving Recess | - |
| Nov 24, 2026 | Tuesday | Thanksgiving Recess | - |
| Nov 25, 2026 | Wednesday | Thanksgiving Recess | - |
| Nov 26, 2026 | Thursday | Thanksgiving Day | Thanksgiving Recess |
| Nov 27, 2026 | Friday | Day after Thanksgiving | Thanksgiving Recess |
| Dec 18, 2026 | Friday | Secondary Pupil Free Day | - |
| Dec 21, 2026 | Monday | Winter Recess | - |
| Dec 22, 2026 | Tuesday | Winter Recess | - |
| Dec 23, 2026 | Wednesday | Winter Recess | - |
| Dec 24, 2026 | Thursday | Christmas Eve (observed) | Winter Recess |
| Dec 25, 2026 | Friday | Christmas Day | Winter Recess |
| Dec 28, 2026 | Monday | Winter Recess | - |
| Dec 29, 2026 | Tuesday | Winter Recess | - |
| Dec 30, 2026 | Wednesday | Winter Recess | - |
| Dec 31, 2026 | Thursday | New Year's Eve (observed) | Winter Recess |
| Jan 01, 2027 | Friday | New Year's Day | Winter Recess |
| Jan 18, 2027 | Monday | Martin Luther King, Jr. Day | - |
| Feb 12, 2027 | Friday | Lincoln's Birthday | - |
| Feb 15, 2027 | Monday | Presidents' Day | - |
| Mar 15, 2027 | Monday | Spring Recess | - |
| Mar 16, 2027 | Tuesday | Spring Recess | - |
| Mar 17, 2027 | Wednesday | Spring Recess | - |
| Mar 18, 2027 | Thursday | Spring Recess | - |
| Mar 19, 2027 | Friday | Spring Recess | - |
| Mar 26, 2027 | Friday | Spring Travel Day | - |
| Mar 29, 2027 | Monday | In Lieu Admission Day | - |
| Apr 26, 2027 | Monday | Nonwork day for employees under 12 months | - |
| May 31, 2027 | Monday | Memorial Day | - |

### In session, but shortened

Class meets. Plan for a compressed period.

| Date | Weekday | Note |
|---|---|---|
| Oct 27, 2026 | Tuesday | Staff development (minimum day) |
| Dec 14, 2026 | Monday | Finals week (minimum day) |
| Dec 15, 2026 | Tuesday | Finals week (minimum day) |
| Dec 16, 2026 | Wednesday | Finals week (minimum day) |
| Dec 17, 2026 | Thursday | Finals week (minimum day) |
| Jan 26, 2027 | Tuesday | Staff development (minimum day) |
| Mar 02, 2027 | Tuesday | Staff development (minimum day) |
| May 27, 2027 | Thursday | Finals week (minimum day) |
| May 28, 2027 | Friday | Finals week (minimum day) |
| Jun 01, 2027 | Tuesday | Finals week (minimum day) |
| Jun 02, 2027 | Wednesday | Finals week (minimum day) |
| Jun 03, 2027 | Thursday | Last day (minimum day) |
...
* Using any unauthorized materials, technological devices, or concealed information during an exam or on an independent assignment. This includes notes, phones, smartwatches, and any calculator not approved for that assessment.
...
* Fabricating or altering data. In a statistics course that includes inventing, padding, or “adjusting” the data you collected for the Statistics Lab.
...
Artificial Intelligence (AI) tools (e.g., Gemini, AI-powered calculators, coding assistants) are increasingly present in education. To describe what is and is not allowed in this room, I use a Green / Yellow / Red framework.
...
* Notification settings in Aeries and MyOpenMath should be set to receive alerts when I send out an announcement.

* Daily classwork and homework are due at the start of the class period on the due date. If work has not been manually submitted in MyOpenMath by then, it will be automatically submitted as it stands at that time.

* Dates are subject to change. In the event of a conflict, the due dates posted in MyOpenMath will govern.

**Disclaimer:** This syllabus constitutes a contract between instructor and student. The instructor reserves the right to alter elements of this syllabus as appropriate, with written notice to the class posted in MyOpenMath. It will be the responsibility of the students to ensure they possess the latest version of the class syllabus.